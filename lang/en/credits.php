...
return [
    ...
    'buy' => [
        ...
        'estimate' => '≈ :count try-ons',
        'tiers' => [
            'starter' => 'Perfect for a first test run',
            'standard' => 'Popular with growing shops',
            'scale' => 'Best value for most stores',
            'pro' => 'Built for high-traffic stores',
        ],
