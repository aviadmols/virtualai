...
return [
    ...
    'settings' => [
        ...
        'kling' => [
            ...
            'sub' => 'Kling\'s own API — images, VIRTUAL TRY-ON (Kolors) and video. Paste the API key from kling.ai/dev/api-key (it starts with “api-key-kling-”) — that alone is enough. The Access + Secret pair below is the legacy alternative: use it only if your account has no API key, and set BOTH. Then use “Test connection”.',
