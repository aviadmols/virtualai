...
return [
    ...
    'storyboard' => [
        ...
        'combine_ratio' => 'Structure (aspect ratio)',
        'combine_resolution' => 'Resolution (DPI)',
        'combine_seconds' => 'Total length (seconds)',
        'combine_seconds_help' => 'All frames are joined in order into one video of this length. AI video models cap the length per call (often 10–15s) — longer requests are clamped to the model\'s maximum.',
        'final_video' => 'Final video',
        'final_video_generating' => 'Building your video…',
        'final_video_status' => 'Sent to :provider (:model) — provider status: :status · checks so far: :polls',
        'final_video_not_submitted' => 'Preparing the submission…',
        'clip_status' => 'Clip sent to :provider — check #:polls…',
        ...
        'dialogue' => 'Dialogue',
        'dialogue_placeholder' => 'What does the character say in this frame?',
        'dialogue_hint' => 'Spoken in this frame (:time) — up to :chars characters so it fits the scene.',
        'dialogue_saved' => 'Dialogue saved',
        'dialogue_too_long' => 'The line is too long for this frame — up to :chars characters fit its seconds.',
        'motion' => 'Motion',
        'motion_camera_placeholder' => 'Camera work — e.g. "slow push-in from wide to medium"',
        'motion_placeholder' => 'Camera + subject motion for the clip — e.g. "she turns toward the door as the camera pushes in"',
        'motion_hint' => 'The clip animates exactly this — the shot plan wrote it; refine it freely.',
        'motion_saved' => 'Motion saved',
        'improve_apply' => 'Apply',
        ...
        'field' => [
            ...
            'aspect' => 'Aspect ratio',
            'duration' => 'Duration (seconds)',
            'interval' => 'Shot pacing (seconds)',
            'interval_help' => 'A pacing hint — the AI director decides the actual cuts; a single shot may run up to about twice this. Total duration is always exact.',
            'resolution' => 'Resolution',
        ...
        'step' => [
            'storyboard_asset_analysis' => 'Reference analysis (vision)',
            'storyboard_story_director' => 'Story director (locked plan)',
            ...
            'storyboard_video_director' => 'Film director (final video prompt)',
            'storyboard_improve_prompt' => 'Improve prompt (on-demand)',
        ],
        ...
        'pipe' => [
            ...
            'aspect' => 'Aspect ratio',
            'aspect_help' => 'The operation default — each project\'s own aspect overrides it at generation time.',
            'first_frame_model' => 'First-frame model',
            'first_frame_model_help' => 'The premium look-setting model for a frame with no previous-shot anchor (usually frame 1). Chained frames run the default model. Empty = always the default.',
            'resolution' => 'Resolution',
            'ratio' => 'Ratio',
            'min_clip' => 'Min clip seconds',
            'max_clip' => 'Max clip seconds',
            'clip_bounds_help' => 'Each clip runs its frame\'s locked shot length, clamped into these bounds.',
        ],
        'asset' => [
    ...
    'models' => [
        ...
        'field' => [
            ...
            'cost_hint_required_byteplus' => 'A flat-rate model (BytePlus, xAI, fal.ai) needs a per-image price (in USD, above 0) — it returns no cost, so this is the price you charge.',
            'cost_unit' => 'Cost unit',
            'is_active' => 'Active',
        ],
        'unit' => [
    ...
    'settings' => [
        ...
        'fal' => [
            'title' => 'fal.ai',
            'sub' => 'The API key for fal.ai — images AND video through one queue API, with the full public model catalog (Krea, FLUX, Kling, Veo and more) selectable per step.',
            'api_key' => 'fal.ai API key',
            'test' => 'Test fal.ai',
            'test_ok' => 'fal.ai connected',
            'test_fail' => 'fal.ai connection failed',
            'test_not_configured' => 'No fal.ai key is set yet — paste your key above and test again.',
            'test_invalid' => 'fal.ai rejected this key (invalid or revoked).',
            'test_timeout' => 'Could not reach fal.ai. Check the network and try again.',
        ],
        'kling' => [
            'title' => 'Kling (Kuaishou)',
            'sub' => 'Kling\'s own API — images, VIRTUAL TRY-ON (Kolors) and video. Paste the API key from kling.ai/dev/api-key (it starts with “api-key-kling-”) — that alone is enough. The Access + Secret pair below is the legacy alternative: use it only if your account has no API key, and set BOTH. Then use “Test Kling”.',
            'api_key' => 'Kling API key (recommended)',
            'access_key' => 'Kling access key (legacy)',
            'secret_key' => 'Kling secret key (legacy)',
            'test' => 'Test Kling',
            'test_ok' => 'Kling connected',
            'test_fail' => 'Kling connection failed',
            'test_not_configured' => 'No Kling credential saved — enter the API key, or save BOTH the access key and the secret key, then test again.',
            'test_invalid' => 'Kling rejected these credentials (check the key, and that the region host matches your account).',
            'test_timeout' => 'Could not reach Kling. Check the network and try again.',
        ],
        'smtp' => [
            'title' => 'Email (SMTP)',
